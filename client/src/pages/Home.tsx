...
export default function Home() {
  useEffect(() => {
    document.title = 'SKYTRONIQX - Electronics Shop Nairobi | Best Electronics Store Kenya';
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'SKYTRONIQX - Leading electronics shop in Nairobi. Best prices on smartphones, laptops, TVs & home appliances in Kenya. Cash on delivery available. Shop online electronics store Kenya.');
    }
  }, []);
